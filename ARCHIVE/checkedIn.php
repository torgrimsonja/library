	...
	<!-- Begin HTML5 content -->
        ...
        <h2 class="title" style="text-align:center;"><a>Welcome to the Library Sign In</a></h2>
            ...
            <ul data-role="listview" data-inset="true" class="ui-listview ui-listview-inset ui-corner-all ui-shadow">
                <li data-role="list-divider" data-swatch="a" data-theme="a" data-form="ui-bar-a" role="heading" class="ui-li ui-li-divider ui-bar-a ui-first-child" style="font-size: 16pt;">Sign in Successful</li>
                <li data-form="ui-btn-up-a" data-swatch="a" data-theme="e" class="ui-li ui-li-static ui-btn-up-a" style="font-size: 20pt; text-align:center;">When you're done in the Library, just scan your ID card again to sign out.</li>
            </ul>
